    ...
    <div class="col-md-3" style="padding-top:20px">
        <ol class="list-inline">
            ...
            <c:if test="${not empty loginUser}">
                ...
                <li><a href="${pageContext.request.contextPath}/jsp/product_list.jsp">购物车</a></li>
    ...
    $(function(){
        ...
        $.post(url, obj, function (data) {
            $.each(data, function (i, obj) {
                var li="<li><a href='${pageContext.request.contextPath}/ProductServlet?method=findProductsWithCidAndPage&num=1&cid="+obj.cid+"&cname="+obj.cname+"'>"+obj.cname+"</a></li>"
                $("#myUL").append(li);
            });
        },"json");
    });
