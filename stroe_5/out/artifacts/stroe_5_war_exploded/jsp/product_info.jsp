		...
		<div class="container">
			<div class="row">
				...
				<div style="margin:0 auto;width:950px;">
					...
					<div class="col-md-6">
                        <form id="myForm" method="post" action="CartServlet?method=addCartItemToCart">
						<div><strong>${product.pname}</strong></div>
						<div style="border-bottom: 1px dotted #dddddd;width:350px;margin:10px 0 10px 0;">
							<div>编号：${product.pid}</div>
						</div>

						<div style="margin:10px 0 10px 0;">商城价: <strong style="color:#ef0101;">￥：${product.shop_price}</strong>市场价:<del>￥${product.market_price}元</del>
						</div>
...
<%--								</a> &nbsp;收藏商品</div>--%>
                                    <input type="submit" value="加入购物车" style="background: url('${pageContext.request.contextPath}/img/product.gif') no-repeat scroll 0 -600px rgba(0, 0, 0, 0);height:36px;width:127px;">&nbsp;收藏商品</div>
						</div>
                        </form>
					</div>
				</div>
...
<%--        document.getElementById("myForm").action="http://www.51cto.com";--%>
