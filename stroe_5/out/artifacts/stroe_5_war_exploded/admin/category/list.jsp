                                ...
                                <c:forEach items="${allCats}" var="cats" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/AdminCategoryServlet?method=editCategoryUI&oldName=${cats.cname}">
													<img src="${pageContext.request.contextPath}/img/admin/i_edit.gif" border="0" style="CURSOR: hand">
												</a>
											</td>
									
											<td align="center" style="HEIGHT: 22px">
												<a href="${pageContext.request.contextPath}/AdminCategoryServlet?method=delCategory&cname=${cats.cname}">
