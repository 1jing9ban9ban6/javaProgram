                                ...
                                <c:forEach items="${list}" var="o" varStatus="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td style="CURSOR: hand; HEIGHT: 22px" align="center"
                                                ...
                                                <c:if test="${o.state==2}">
                                                    <a href="${pageContext.request.contextPath}/AdminOrderServlet?method=updateOrderById&oid=${o.oid}">发货</a>
                                                </c:if>
											...
											<td align="center" style="HEIGHT: 22px" width="60%">
		                                        ...
		                                        <table border="1" width="100%" id="myTb">
...
<script>
    $(function () {
        $(".myClass").click(function () {
            ...
            var $tb = $(this).next();
            if(text =="订单详情"){
                var url = "/store_5/AdminOrderServlet"
                ...
                $.post(url,obj,function (data) {
                    ...
                    $.each(data,function (i, obj) {
                        var td = "<tr><td><img src='/store_5/"+obj.product.pimage+"' width='50px'/></td><td>"+obj.product.pname+"</td><td>"+obj.product.shop_price+"</td><td>"+obj.quantity+"</td></tr>";
                        $tb.append(td)
                    })
                },"json")
                this.value="关闭"
