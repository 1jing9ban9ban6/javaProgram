...
import com.jing.weiming.dao.IStockDao;
...
//        resultMap.put("msg", "");
    ...
    public Map<String, Object> getStockById(String sku_id){
        ...
        //2、取stockDao的方法
        ArrayList<Map<String, Object>> list = iStockDao.getStockById(sku_id);
...
//        resultMap.put("msg", "");
    ...
    public Map<String, Object> insertLimitPolicy(Map<String, Object> policyInfo){
        ...
        //redis存商品
        ArrayList<Map<String, Object>> list = iStockDao.getStockById(policyInfo.get("sku_id").toString());
